...
describe('fieldValue', function () {
  describe('makeFieldValue', function () {
    ...
    it('should not affect deep equal', function () {
      ...
      (0, _expect2.default)(someObject).toEqual(Object.defineProperties({ b: 1 }, {
    ...
    it('should be still field value after object recreation', function () {
      var someObject = (0, _fieldValue.makeFieldValue)({ b: 1 });
      (0, _expect2.default)((0, _fieldValue.isFieldValue)(someObject)).toBe(true);

      var recreatedObject = JSON.parse(JSON.stringify(someObject));
      (0, _expect2.default)((0, _fieldValue.isFieldValue)(recreatedObject)).toBe(true);
    });
  });
