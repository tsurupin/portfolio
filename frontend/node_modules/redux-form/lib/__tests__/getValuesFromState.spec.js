...
describe('getValuesFromState', function () {
  ...
  it('should retrieve values from recreated state', function () {
    var initialState = {
      foo: (0, _fieldValue.makeFieldValue)({
        value: 'bar'
      })
    ...
    (0, _expect2.default)((0, _getValuesFromState2.default)(initialState)).toEqual({
      foo: 'bar'
    });

    var serializedState = JSON.stringify(initialState);
    var unSerializedState = JSON.parse(serializedState);

    (0, _expect2.default)((0, _getValuesFromState2.default)(unSerializedState)).toEqual({
      foo: 'bar'
    });
  });
});