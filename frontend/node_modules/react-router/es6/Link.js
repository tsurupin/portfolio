...
var Link = React.createClass({
  ...
  handleClick: function handleClick(event) {
    !this.context.router ? process.env.NODE_ENV !== 'production' ? invariant(false, '<Link>s rendered outside of a router context cannot handle clicks.') : invariant(false) : void 0;
