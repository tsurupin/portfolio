...
var nodelibsPathPrefix = 'github:jspm/nodelibs-';
var nodelibsVersion = '@^0.2.0-alpha';
...
exports.convertPackage = function(packageConfig, packageName, packageDir, ui) {
    ...
    readdirp({
      ...
      directoryFilter: function(dir) {
        ...
        if (packageConfig.files instanceof Array) {
          return packageConfig.files.some(function(file) {
  ...
  .then(function(fileTree) {
    if (systemConfig.main) {
      if (systemConfig.main == '.')
        systemConfig.main = '';
      else if (systemConfig.main.substr(0, 2) == './')
        systemConfig.main = systemConfig.main.substr(2);
      if (systemConfig.main[systemConfig.main.length - 1] == '/')
