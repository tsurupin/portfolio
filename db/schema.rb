...
ActiveRecord::Schema.define(version: 20160415005054) do
  ...
  add_index "article_taggings", ["article_id", "article_tag_id"], name: "index_article_taggings_on_article_id_and_article_tag_id", unique: true
  ...
  add_index "items", ["article_id", "sort_rank"], name: "index_items_on_article_id_and_sort_rank"
